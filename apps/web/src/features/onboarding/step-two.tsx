...
export function StepTwo() {
  ...
  const toggleService = (srv: string) => {
    if (selectedServices.includes(srv)) {
      ...
      setValue("serviceCategories", [...selectedServices, srv], {
        shouldDirty: true,
        shouldValidate: true,
      });
    }
    ...
    <div className="space-y-8 animate-in fade-in duration-300">
      <div className="space-y-1.5">
        ...
        <p className="text-sm text-neutral-500">
          Select all that apply. This personalizes your pipeline and intake
          form.
        </p>
      </div>
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  isSelected
                    ? "border-[#00B464] bg-[#00B464] text-white"
          ...
          {[
            {
              id: "solo",
              title: "Solo - Just Me",
              desc: "I handle Everything Myself",
            },
            {
              id: "2_5",
              title: "Small Team - 2 to 5 People",
              desc: "We collaborate on projects together",
            },
            {
              id: "6_15",
              title: "Medium Team - 6 to 15 People",
              desc: "We have a dedicated team for projects",
            },
            {
              id: "16_plus",
              title: "Large Team - 16+ People",
              desc: "We have multiple teams and departments",
            },
          ].map((opt) => (
            <div
              key={opt.id}
              ...
              className={cn(
                ...
                activeStyle === opt.id
                  ? "border-[#00B464] bg-emerald-50/10"
            ...
            >
              ...
              >
                {activeStyle === opt.id && (
                  <div className="w-2 h-2 rounded-full bg-[#00B464]" />
                )}
              </div>
              <div>
                <p
          ...
          {[
            {
              id: "under_1000",
              label: "Under $1,000",
              desc: "Small projects & quick turnarounds",
            },
            {
              id: "1000_5000",
              label: "$1,000 - $5,000",
              desc: "Mid-range projects",
            },
            {
              id: "5000_15000",
              label: "$5,000 - $15,000",
              desc: "Premium studio work",
            },
            {
              id: "15000_plus",
              label: "$15,000+",
              desc: "Enterprise & agency level",
            },
          ].map((bgt) => (
            <div
              key={bgt.id}
